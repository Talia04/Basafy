...
export const PROMPT_B_SYSTEM = `You are an expert at analyzing job application emails. Your task is to extract structured data from the email content provided.
