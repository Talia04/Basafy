-- Migration: Create events and tasks tables, add missing fields to applications, add indexes and RLS

-- 1. Add missing fields to applications
...
-- 5. Enable RLS and add policies for events
...
-- 6. Enable RLS and add policies for tasks
